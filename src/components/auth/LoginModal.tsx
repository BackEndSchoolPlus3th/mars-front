...
import { AuthKakao, AuthGoogle, AuthNaver } from '../../api';
            ...
            <div className="bg-white rounded-lg w-[400px] relative">
                ...
                <div className="p-8">
                    ...
                    <div className="space-y-4">
                        <button
                            onClick={AuthKakao()}
                            className="w-full py-3 px-4 rounded-md bg-[#FEE500] text-black font-medium flex items-center justify-center space-x-2 hover:opacity-90 transition-colors"
                        >
                            <svg
                                width="40"
                                height="40"
